---
title: "Commerce steps"
description: "Stage a buyable storefront listing from a Zap. Commerce steps quote $0, never charge, and file a shop_publish decision for owner approval."
---
...
See [Commerce Agents](/commerce/agents) for the exact catalog entry air
accepts, the field aliases, and what happens after the owner approves.
[Commerce rollout](/commerce/rollout) is the order of operations for taking
