...
<CardGroup cols={3}>
  ...
  <Card title="Namespace" href="/sandboxes/namespace" horizontal>
    <img src="/images/logos/namespace.svg" alt="Namespace" style={{ height: "24px", width: "auto", display: "inline-block" }} noZoom />
    First-party VM
  </Card>
  ...
  <Card title="microsandbox" href="/sandboxes/microsandbox" horizontal>
    <img src="/images/logos/microsandbox.png" alt="microsandbox" style={{ height: "24px", width: "auto", display: "inline-block" }} noZoom />
    Local KVM microVMs
  </Card>
  <Card title="E2B" href="/sandboxes/e2b" horizontal>
    <img src="/images/logos/e2b.png" alt="E2B" style={{ height: "24px", width: "auto", display: "inline-block" }} noZoom />
    Firecracker microVMs
  </Card>
  <Card title="Daytona" href="/sandboxes/daytona" horizontal>
    <img src="/images/logos/daytona.png" alt="Daytona" style={{ height: "24px", width: "auto", display: "inline-block" }} noZoom />
    Container sandboxes
  </Card>
  <Card title="Cloudflare" href="/sandboxes/cloudflare" horizontal>
    <img src="/images/logos/cloudflare.svg" alt="Cloudflare" style={{ height: "24px", width: "auto", display: "inline-block" }} noZoom />
    Workers containers
  </Card>
  <Card title="Modal (GPU)" href="/sandboxes/modal" horizontal>
    <img src="/images/logos/modal.svg" alt="Modal" style={{ height: "24px", width: "auto", display: "inline-block" }} noZoom />
    GPU lane only
  </Card>
  <Card title="Docker" href="/sandboxes/docker" horizontal>
    <img src="/images/logos/docker.svg" alt="Docker" style={{ height: "24px", width: "auto", display: "inline-block" }} noZoom />
    Local containers
  </Card>
</CardGroup>
