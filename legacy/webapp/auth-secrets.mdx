...
For Supabase server-side setup — deploying the `zap-user-secrets` and `zap-wallet-proof` Edge Functions and configuring the required encryption secrets — see the [Supabase Secrets deployment guide](/legacy/deployment/supabase-secrets).
