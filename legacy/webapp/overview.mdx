...
<CardGroup cols={2}>
  <Card title="POST /api/zaps/run" icon="play" href="/legacy/webapp/overview#post-apizapsrun">
  ...
  <Card title="GET /api/skills" icon="list" href="/legacy/webapp/overview#get-apiskills">
    Return the full skill manifest — recipe names, hashes, and download URLs — used by agents to bootstrap a project.
  </Card>
  <Card title="GET /api/zaps" icon="bolt" href="/legacy/webapp/overview#get-apizaps">
  ...
  <Card title="PUT /api/secrets" icon="key" href="/legacy/webapp/auth-secrets">
  ...
  <Card title="POST /api/auth/wallet-proof" icon="wallet" href="/legacy/webapp/auth-secrets#connecting-your-wallet">
