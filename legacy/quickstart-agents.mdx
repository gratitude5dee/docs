...
<Note>
  For a deeper look at the agent framework architecture — Eve conventions, the `run_zap` tool, step primitives, and how Convex and Upstash back the live runtime — see [Agent Overview](/legacy/agent/overview).
</Note>
