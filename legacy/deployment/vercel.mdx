...
<Steps>
  ...
  <Step title="Apply Supabase migrations">
    ...
    See the [Supabase Secrets guide](/legacy/deployment/supabase-secrets) for the full migration details and required edge function setup.
  </Step>
