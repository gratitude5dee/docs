---
title: "Package index"
description: "Every published @wzrdtech workspace at 5.0.0: what each one does and how to install it."
---

Everything ships at version `5.0.0`. Install what you need:
...
| package | purpose |
| --- | --- |
| `@wzrdtech/zap` | The `zap` CLI and MCP entry point. `npx -y @wzrdtech/zap@5.0.0` for one-off commands. |
