...
description: "A content-addressed store for generated media on med+ runtimes, rooted at /zap/media, with provenance sidecars."
---
...
```bash
zap media ls [--json]         # inspect local media outputs
zap media info <path> [--json]
zap fs ls <runtime-id> /zap/media --json
```
