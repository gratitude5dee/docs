...
<CardGroup cols={3}>
  <Card title="OpenRouter" horizontal>
    <img className="block dark:hidden" src="/images/logos/openrouter-light.svg" alt="OpenRouter" height="24" noZoom />
    <img className="hidden dark:block" src="/images/logos/openrouter-dark.svg" alt="OpenRouter" height="24" noZoom />
    Route: `openrouter` (default)
  </Card>
  <Card title="OpenAI" horizontal>
    <img className="block dark:hidden" src="/images/logos/openai-light.svg" alt="OpenAI" height="24" noZoom />
    <img className="hidden dark:block" src="/images/logos/openai-dark.svg" alt="OpenAI" height="24" noZoom />
    Route: `openai`
  </Card>
  <Card title="Anthropic" horizontal>
    <img className="block dark:hidden" src="/images/logos/anthropic-light.svg" alt="Anthropic" height="24" noZoom />
    <img className="hidden dark:block" src="/images/logos/anthropic-dark.svg" alt="Anthropic" height="24" noZoom />
    Route: `anthropic`
  </Card>
  <Card title="xAI" horizontal>
    <img className="block dark:hidden" src="/images/logos/xai-light.svg" alt="xAI" height="24" noZoom />
    <img className="hidden dark:block" src="/images/logos/xai-dark.svg" alt="xAI" height="24" noZoom />
    Route: `xai`
  </Card>
  <Card title="Vercel AI Gateway" horizontal>
    <img className="block dark:hidden" src="/images/logos/vercel-light.svg" alt="Vercel" height="24" noZoom />
    <img className="hidden dark:block" src="/images/logos/vercel-dark.svg" alt="Vercel" height="24" noZoom />
    Route: `gateway`
  </Card>
  <Card title="GMI Cloud" horizontal>
    <img src="/images/logos/gmi.png" alt="GMI Cloud" height="24" noZoom />
    Route: `gmi`
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  <Card title="AWS Bedrock" horizontal>
    <img src="/images/logos/bedrock.svg" alt="AWS Bedrock" height="24" noZoom />
    Provider: `aws`
  </Card>
  <Card title="Vertex AI" horizontal>
    <img src="/images/logos/vertexai.svg" alt="Vertex AI" height="24" noZoom />
    Provider: `vertex`
  </Card>
  <Card title="fal" horizontal>
    <img src="/images/logos/fal.svg" alt="fal" height="24" noZoom />
    Provider: `fal`
  </Card>
  <Card title="Prodia" horizontal>
    <img src="/images/logos/prodia.png" alt="Prodia" height="24" noZoom />
    Provider: `prodia`
  </Card>
  <Card title="Runware" horizontal>
    <img src="/images/logos/runware.svg" alt="Runware" height="24" noZoom />
    Provider: `runware`
  </Card>
  <Card title="Replicate" horizontal>
    <img className="block dark:hidden" src="/images/logos/replicate-light.svg" alt="Replicate" height="24" noZoom />
    <img className="hidden dark:block" src="/images/logos/replicate-dark.svg" alt="Replicate" height="24" noZoom />
    Provider: `replicate`
  </Card>
  <Card title="GMI Cloud" horizontal>
    <img src="/images/logos/gmi.png" alt="GMI Cloud" height="24" noZoom />
