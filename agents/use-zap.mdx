...
<Tabs>
  <Tab title="Claude Code">
    <img src="/images/logos/claude.svg" alt="Claude" height="28" noZoom />
  ...
  <Tab title="Cursor">
    <img className="block dark:hidden" src="/images/logos/cursor-light.svg" alt="Cursor" height="28" noZoom />
    <img className="hidden dark:block" src="/images/logos/cursor-dark.svg" alt="Cursor" height="28" noZoom />
  ...
  <Tab title="Codex">
    <img className="block dark:hidden" src="/images/logos/codex-light.svg" alt="Codex" height="28" noZoom />
    <img className="hidden dark:block" src="/images/logos/codex-dark.svg" alt="Codex" height="28" noZoom />
  ...
  <Tab title="Devin">
    <img src="/images/logos/devin.svg" alt="Devin" height="28" noZoom />
  ...
  <Tab title="OpenClaw">
    <img src="/images/logos/openclaw.svg" alt="OpenClaw" height="28" noZoom />
