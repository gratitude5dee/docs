...
<Tabs>
  <Tab title="Claude Code">
    <img src="/images/logos/claude.svg" alt="Claude" style={{ height: "28px", width: "auto" }} noZoom />
  ...
  <Tab title="Cursor">
    <img className="block dark:hidden" src="/images/logos/cursor-light.svg" alt="Cursor" style={{ height: "28px", width: "auto" }} noZoom />
    <img className="hidden dark:block" src="/images/logos/cursor-dark.svg" alt="Cursor" style={{ height: "28px", width: "auto" }} noZoom />
  ...
  <Tab title="Codex">
    <img className="block dark:hidden" src="/images/logos/codex-light.svg" alt="Codex" style={{ height: "28px", width: "auto" }} noZoom />
    <img className="hidden dark:block" src="/images/logos/codex-dark.svg" alt="Codex" style={{ height: "28px", width: "auto" }} noZoom />
  ...
  <Tab title="Devin">
    <img className="block dark:hidden" src="/images/logos/devin-light.svg" alt="Devin" style={{ height: "28px", width: "auto" }} noZoom />
    <img className="hidden dark:block" src="/images/logos/devin-dark.svg" alt="Devin" style={{ height: "28px", width: "auto" }} noZoom />
  ...
  <Tab title="OpenClaw">
    <img className="block dark:hidden" src="/images/logos/openclaw-light.svg" alt="OpenClaw" style={{ height: "28px", width: "auto" }} noZoom />
    <img className="hidden dark:block" src="/images/logos/openclaw-dark.svg" alt="OpenClaw" style={{ height: "28px", width: "auto" }} noZoom />
