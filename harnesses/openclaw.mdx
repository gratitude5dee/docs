...
<img className="block dark:hidden" src="/images/logos/openclaw-light.svg" alt="OpenClaw" style={{ height: "32px", width: "auto" }} noZoom />

<img className="hidden dark:block" src="/images/logos/openclaw-dark.svg" alt="OpenClaw" style={{ height: "32px", width: "auto" }} noZoom />
